...
import (
	...
	"greenlight.karolharasim.net/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "bbbf4a3f54ce32", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "e09f7d9809e03c", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.karolharasim.net>", "SMTP sender")
